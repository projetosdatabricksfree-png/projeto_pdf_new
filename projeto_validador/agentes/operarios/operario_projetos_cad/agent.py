...
class OperarioProjetosCAD:
    ...
    def processar(self, payload: RoutingPayload) -> TechnicalReport:
        ...
        try:
            ...
            v05 = check_binding_margin(file_path, encadernacao)
